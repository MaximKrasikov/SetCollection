...
/*возвращает индексы людей, которые у тебя в друзьях уже есть и которых ты можешь знать*/
    public Set<Integer> getAllFriendsAndPotentialFriends(int index, int deep) {
        Set<Integer> result = new HashSet<>();
        if (deep == 0) return result;// сам человек
        for (int i = 0; i < humansRelationships.length; i++) {// проход по всему массиву
            if (i < index) {
    ...
    //все потенциальные друзья человека с индексом index и глубиной поиска deep.
